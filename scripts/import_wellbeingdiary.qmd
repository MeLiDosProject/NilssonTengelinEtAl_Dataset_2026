...
## Only RISE - recoding who questions

RISE incorrectly coded the REDcap questions for who5. The following code cell corrects for that:

```{r}
data <- 
data |> 
  mutate(
    across(starts_with("who5_1998_"),
           \(x) replace_values(
             x,
             1 ~ 5,
             2 ~ 4,
